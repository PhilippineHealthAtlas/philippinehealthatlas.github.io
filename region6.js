...
var spreadsheets = [
	...
	{
		'key' : '0AoBD4uHCApskdHpzTG5RZk5JSzZIS04wQm5uNFZrUEE/od6',
...
function showImages(image) {
	...
	var newtext = '';
	for (var i in image) {
		newtext += '<img src="http://i1307.photobucket.com/albums/s597/dohmapsvi/' + image[i] + '" width="330"/>';
	}
	return newtext;
}
...
var facility_attributes = {
	'pcofinfra2011' : {
		...
		'details': 
			'</br><img src="2012.png"> Health Facilities w/ HFEP 2011'
	...
	'pcofinfra2012' : {
		...
		'categ' : function(val) { 
			if (parseInt(val) > 0) { return 'H2012.png'; } else { return '5p.png'; }
			},
		'details': 
