...
function getInfoText(datum) {
	return ''
		...
		// Services Offered
		+ (datum.facilitytype || datum.servicecapability || datum.bemonc ? '<br/><br/><h2>Services Offered</h2>':'')
		...
		// Equipment Available
		+ (datum.ambulance || datum.autoclave ? '<br/><br/><h2>Equipment Available</h2>':'')
		...
		// Human Resources
		+ (datum.facilitytype || datum.servicecapability || datum.md2013 ? '<br/><br/><h2>Human Resource Complement</h2>':'')
		+ '<table>'
