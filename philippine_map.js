...
var spreadsheets = [
	...
	{
		'key' : '0Aq7eQ20tUwmTdHdHMEtMOURzZFYtbF92WWhvZWxVcmc/od6',
	...
	{
		'key' : '0Aq7eQ20tUwmTdHdHMEtMOURzZFYtbF92WWhvZWxVcmc/od7',
	...
	{
		'key' : '0Aq7eQ20tUwmTdC1TMF9mMVhCWkxsZUFpZWVZdVZSdUE/od6',
...
var polygon_spreadsheets = [
	{
		'key' : '0Aq7eQ20tUwmTdHdHMEtMOURzZFYtbF92WWhvZWxVcmc/od8',
...
var attributes = {
	...
	'privatehospital' : {
		...
		'is_indicator' : true,
		'categ' : function(val) { 
			return ( val > 16 ? 'orange' : val > 15? 'blue' : val > 10 ? 'green' : (val < 6 ? (val == 0 ? 'gray' : 'red') : 'green')); 
			},
		'description' : 'Private Hospital',
		'details': 
			...
			+'</br><span style="color:orange;background-color:orange">__</span> >16'
			+'</br><span style="color:gray;background-color:gray">__</span> No Data'
	},
	'governmenthospital' : {
