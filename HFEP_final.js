...
var spreadsheets = [
	...
	{ 
		'is_title' : true,
		'description' : '<br/><h2>HFEP Monitoring</h2>'
	},
	{
		'key' : '117qug5kewm7Md2mLnvOIwnU6oEBNNGgxuFAznrlUZcI/od7',
		...
		'groupby' : {
			'field' : 'facilitytype',
			'values' : ['HOSPITAL','RURAL HEALTH UNIT']
	},
		size:22
	},
	{
		'key' : '117qug5kewm7Md2mLnvOIwnU6oEBNNGgxuFAznrlUZcI/od4',
	...
	{
		'key' : '117qug5kewm7Md2mLnvOIwnU6oEBNNGgxuFAznrlUZcI/od5',
	...
	{
		'key' : '117qug5kewm7Md2mLnvOIwnU6oEBNNGgxuFAznrlUZcI/ocy',
		'description' : 'HFEP 2014',
		'keyword' : 'HFEP_2014',
		'marker' : '2014.png',
		'hideLayer' : true,
		'zIndex' : 10,
...
var polygon_spreadsheets = [
	...
	{
		'key' : '1-zJW3eGcYdq0LOSYJMp-zrLcG_osg3nnp2SJ2M12RHM/ocw',
		'description' : 'Health Facility Enhancement Program',
		'keyword' : 'Health_Enhancement_Program',
		'hideLayer' : true,
		size:12
	},
];
...
var attributes = {
	...
	'hfeptotalcummillions' : {
		
		'is_indicator' : true,
		'description' :  '<acronym title="Health Facilities Enhancement Program">HFEP Total Cummulative</acronym> (Php M)',
		'categ' : function(val) { 
			return ( val > 600 ? '#27480e' : val > 450 ? '#386915' : val > 300 ? '#4a891b' : (val < 150 ? (val == 0 ? 'gray' : '#77d631') : '#5baa22')); 
			},
		'details': 
			'</br><span style="color:#77d631;background-color:#77d631">__</span> 1 - 150'
			...
			+'</br><span style="color:#27480e;background-color:#27480e">__</span> 601 and above'
...
function getInfoText(datum) {
	...
	// Basic Information	
		...
		// HFEP Allocation
		+ (datum.equip2011 || datum.infra2011  || datum.total2011 || datum.description2011 || datum.equip2012 || datum.infra2012  || datum.total2012 || datum.description2012 ||datum.equip2013 || datum.infra2013  || datum.total2013 || datum.description2013 ||datum.equip2014 || datum.infra2014  || datum.total2014 || datum.description2014 ? '<br/><br/><h2>HFEP Allocation</h2>':'')
		+ (datum.infra2014 && datum.infra2014.length > 0? '<br/><b>HFEP Infrastracture 2014</b>: ' + commatize(datum.infra2014) : '')
		+ (datum.equip2014 && datum.equip2014.length > 0? '<br/><b>HFEP Equipment 2014</b>: ' + commatize(datum.equip2014) : '')
		+ (datum.total2014 && datum.total2014.length > 0? '<br/><b>HFEP Total 2014</b>: ' + commatize(datum.total2014) : '')
		+ (datum.description2014 && datum.description2014.length > 0? '<br/><b>Description 2014</b>: ' + (datum.description2014) : '')
